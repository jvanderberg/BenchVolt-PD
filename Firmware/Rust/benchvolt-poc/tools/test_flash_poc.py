...
def image_of_size(size: int, reset_offset: int = 192) -> bytearray:
    ...
    struct.pack_into(
        ...
        0,
        0x2000_4000,
        (flash_poc.APP_ORIGIN + reset_offset) | 1,
    )
    return image
